...
struct StringHashMapCell : public HashMapCell<Key, Value, StringHashTableHash, HashTableNoState> {
    using Base = HashMapCell<Key, Value, StringHashTableHash, HashTableNoState>;
...
struct StringHashMapCell<StringKey16, Value> : public HashMapCell<StringKey16, Value, StringHashTableHash, HashTableNoState> {
    using Base = HashMapCell<StringKey16, Value, StringHashTableHash, HashTableNoState>;
    using value_type = typename Base::value_type;
    using Base::Base;
    static constexpr bool need_zero_value_storage = false;
    ...
    static bool isZero(const StringKey16 &key, const HashTableNoState &) { return key.b == 0; }
    void setZero() { this->value.first.b = 0; }
...
template <typename Value>
struct StringHashMapCell<StringKey24, Value> : public HashMapCell<StringKey24, Value, StringHashTableHash, HashTableNoState> {
    using Base = HashMapCell<StringKey24, Value, StringHashTableHash, HashTableNoState>;
    using value_type = typename Base::value_type;
    using Base::Base;
    static constexpr bool need_zero_value_storage = false;
    bool isZero(const HashTableNoState &state) const { return isZero(this->value.first, state); }
...
template <typename Value>
struct StringHashMapCell<StringRef, Value> : public HashMapCellWithSavedHash<StringRef, Value, StringHashTableHash, HashTableNoState> {
    using Base = HashMapCellWithSavedHash<StringRef, Value, StringHashTableHash, HashTableNoState>;
    using value_type = typename Base::value_type;
    using Base::Base;
    static constexpr bool need_zero_value_storage = false;
    // external
...
struct StringHashMapSubMaps {
    using T0 = StringHashTableEmpty<StringHashMapCell<StringRef, Value>>;
    using T1 = HashMapTable<StringKey8, StringHashMapCell<StringKey8, Value>, StringHashTableHash, StringHashTableGrower<>>;
    using T2 = HashMapTable<StringKey16, StringHashMapCell<StringKey16, Value>, StringHashTableHash, StringHashTableGrower<>>;
    using T3 = HashMapTable<StringKey24, StringHashMapCell<StringKey24, Value>, StringHashTableHash, StringHashTableGrower<>>;
    using Ts = HashMapTable<StringRef, StringHashMapCell<StringRef, Value>, StringHashTableHash, StringHashTableGrower<>>;
};

template <typename Value>
class StringHashMap : public StringHashTable<StringHashMapSubMaps<Value>> {
public:
    using Key = StringRef;
    using Base = StringHashTable<StringHashMapSubMaps<Value>>;
    ...
    inline Value &operator[](const Key &x) {
        LookupResult it;
        bool inserted;
    ...
    template <typename Func>
    void inline forEachValue(Func &&func) {
        if (this->m0.size()) {
    ...
    template <typename Func>
    void inline forEachMapped(Func &&func) {
        if (this->m0.size())
